...
void drawFrame()
{
    ...
    glPushMatrix();
    glTranslatef(0.0f,0.0f,0.06f); //rangka bawah
...
void lighting() // FUNCTION FOR LIGHTING
{
    ...
    GLfloat light_positional[]={1.0,1.0,1.0,1.0};//posisi
...
void init (){
    reset ();
glClearColor(0.0,0.0,1.0,0.0); //ubah backround
}
...
{
   glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT); // hilangkan motor
